...
use anyhow::Result;
use beetle_rpc_client::{
    create_server, GatewayServer, ServerError, ServerSocket, HEALTH_POLL_WAIT,
};
use beetle_rpc_types::{
...
impl beetle_rpc_types::NamedService for Gateway {
