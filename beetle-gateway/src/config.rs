...
/// For example, `BEETLE_GATEWAY_PORT=1000` would set the value of the `Config.port` field
pub const ENV_PREFIX: &str = "BEETLE_GATEWAY";
...
/// integrated into another binary like beetle-one, beetle-share or beetle-embed.
...
/// Configuration for [`beetle-gateway`].
...
mod tests {
    ...
    fn test_toml_file() {
        ...
        let cfg = beetle_util::make_config(
