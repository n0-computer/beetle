...
impl Default for Libp2pConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            gossipsub: true,
            bitswap: true,
            max_conns_pending_out: 256, //256,
            max_conns_pending_in: 256, //256,
            max_conns_in: 256, //256,
            max_conns_out: 256, //256,
            max_conns_per_peer: 8, //8,
            notify_handler_buffer_size: 256, //256,
            connection_event_buffer_size: 256,//256,
            dial_concurrency_factor: 16,//16,
        }
    }
}
