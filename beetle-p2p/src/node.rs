...
use beetle_metrics::{core::MRecorder, inc, libp2p_metrics, p2p::P2PMetrics};
...
use beetle_bitswap::{BitswapEvent, Block};
use beetle_rpc_client::Lookup;
...
mod tests {
    ...
    use super::*;
    use anyhow::Result;
    use beetle_rpc_client::P2pClient;
    use beetle_rpc_types::{p2p::P2pAddr, Addr};
    ...
    impl TestRunnerBuilder {
        ...
        async fn build(self) -> Result<TestRunner> {
            ...
            let cfg = beetle_rpc_client::Config {
    ...
    fn assert_lookup(
        ...
        let expected_agent_version =
            format!("beetle/{}", std::env::var("CARGO_PKG_VERSION").unwrap());
