...
/// For example, `BEETLE_CLI_PATH=/path/to/config` would set the value of the `Config.path` field
pub const ENV_PREFIX: &str = "BEETLE_CLI";

/// The configuration for the beetle cli.
#[derive(PartialEq, Eq, Debug, Deserialize, Serialize, Clone)]
pub struct Config {
    /// The set of services to start if no arguments are given to 'beetle start'
